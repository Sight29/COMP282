...
public class Game
{
   ...
   *  all the different Poker Hands that could be created from the 8 cards (3 in hand, 5 community cards on 'table')
   *  then returned only the strongest hand.
   *
   * param: hand This is the list of cards that are held by an individual player (3 cards)
  ...
  /**
   *
   * param hand the three cards in a given player's hand
   * param communityCards the five community cards
   * param pokerHands a list of all the actual PokerHands that can be made from the eight available cards
   */
